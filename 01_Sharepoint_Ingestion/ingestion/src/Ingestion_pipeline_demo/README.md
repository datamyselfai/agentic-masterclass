# Ingestion_pipeline_demo

This folder defines all source code for the 'Ingestion_pipeline_demo' pipeline:
...
* Take a look at the sample under "sample_users_ingestion_pipeline_demo.py" to get familiar with the syntax.
